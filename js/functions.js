...
function LoadAll()
{
    ...
    {
        clickable = "true";
        localStorage.setItem('clickable', clickable);
    } else {
        clickable = "true";
        localStorage.setItem('clickable', clickable);
    }
...
function ResetToZero()
{
    ...
    localStorage.setItem('MaxCounter', maxCount);
    localStorage.setItem('Points', points);
    localStorage.setItem('TotalCounter', totalCount);
    localStorage.setItem('DogeCoins', dogeCoins);
    localStorage.setItem('SelCheems', SelCheems);
    localStorage.setItem('clickable', clickable);
    localStorage.setItem("SelSound", SelSound);
    localStorage.setItem("CheemsAppLiSelMusic", SelMusic);
...
function ChangeCheems(a, b) {
    ...
    if (canChange) {
        Selcheems = a;
        localStorage.setItem("SelCheems", a);
    }
    PlaySound(SelSound);
    LoadSelection();
}
...
function ChangeSound(a, b) {
    ...
    if (canChange) {
        SelSound = a;
        localStorage.setItem("SelSound", a);
    }
    PlaySound(SelSound);
    LoadSelection();
}
